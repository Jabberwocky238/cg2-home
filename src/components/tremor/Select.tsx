...
const selectTriggerStyles = [
  cx(
    // base
    "group/trigger flex w-full select-none items-center justify-between gap-2 truncate rounded-md px-3 py-2 shadow-xs outline-hidden transition sm:text-sm",
    // border color
    ...
    // hover
    "hover:bg-gray-200/20 dark:hover:bg-gray-950/20",
    // cursor
    "cursor-pointer",
    // disabled
  ...
  return (
    <SelectPrimitives.Item
      ...
      className={cx(
        ...
        // hover
        "hover:bg-gray-100/20 dark:hover:bg-gray-900/20",
        className,
      )}
      {...props}
    >
